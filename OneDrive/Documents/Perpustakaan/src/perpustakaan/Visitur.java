...
public class Visitur extends Library {
    private LocalDate tanggalPinjam;
    private static final int PEMINJAMAN = 3;
    private final Book[] bukuPinjaman;
    ...
    public Visitur(String name, int memberId, int ktp, int par2, String alamat, double denda) {
        super(name, memberId, ktp, alamat, denda);
        this.bukuPinjaman = new Book[MAX_BUKU];
    ...
    public void meminjamBuku(Book buku) {
        ...
        if (buku.tersedia()) {
            ...
            System.out.println(getName() + " Visitor meminjam buku : " + buku.getTitle());
